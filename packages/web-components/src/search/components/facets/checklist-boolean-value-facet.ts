import { BooleanAvailableFacetValue, DataObjectBooleanValueFacetResult, ProductDataBooleanValueFacetResult } from '@relewise/client';
...
export class ChecklistBooleanValueFacet extends ChecklistFacetBase {
    ...
    result: ProductDataBooleanValueFacetResult | DataObjectBooleanValueFacetResult | null = null;
