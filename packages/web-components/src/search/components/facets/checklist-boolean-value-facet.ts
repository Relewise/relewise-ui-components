import { BooleanAvailableFacetValue, ContentDataBooleanValueFacetResult, DataObjectBooleanValueFacetResult, ProductCategoryDataBooleanValueFacetResult, ProductDataBooleanValueFacetResult } from '@relewise/client';
...
export class ChecklistBooleanValueFacet extends ChecklistFacetBase {
    ...
    result: ProductDataBooleanValueFacetResult | ContentDataBooleanValueFacetResult | ProductCategoryDataBooleanValueFacetResult | DataObjectBooleanValueFacetResult | null = null;
