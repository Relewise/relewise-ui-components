import { DataObjectStringValueFacetResult, ProductDataStringValueFacetResult, StringAvailableFacetValue } from '@relewise/client';
...
export class ChecklistStringValueFacet extends ChecklistFacetBase {
    ...
    result: ProductDataStringValueFacetResult | DataObjectStringValueFacetResult | null = null;
