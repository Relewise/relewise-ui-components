    ...
    static styles = [
        ...
        css`
            .rw-search-bar {
                ...
                padding-left: 1rem;
                padding-right: 1rem;
                border: var(--relewise-search-overlay-bar-border, 2px solid);
                border-color: var(--color);
                border-radius: var(--relewise-search-overlay-bar-border-radius, 1rem);
                height: var(--relewise-search-overlay-bar-height, 3rem);
            }
